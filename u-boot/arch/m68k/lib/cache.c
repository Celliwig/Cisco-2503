...
{
	u32 temp = CONFIG_SYS_CACHE_ICACR;
...
{
	u32 temp = CONFIG_SYS_ICACHE_INV;
...
{
	u32 temp = CONFIG_SYS_CACHE_DCACR;
...
{
#if defined(CONFIG_SYS_DCACHE_INV)
	u32 temp = CONFIG_SYS_DCACHE_INV;
